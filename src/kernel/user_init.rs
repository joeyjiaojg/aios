...
pub const USER_INIT_ELF: &[u8] = &[
    ...
    0xA6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // p_memsz  = 0x1000  (one 4KiB page)
    ...
    0x48, 0xBE, 0xA0, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, // mov rdx, 6 (length)
    0x48, 0xC7, 0xC2, 0x06, 0x00, 0x00, 0x00, // int 0x80
    0xCD, 0x80, // jmp $ (infinite loop)
    0xEB, 0xFE, // Padding to align message
